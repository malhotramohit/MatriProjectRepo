...
import com.matri.Matri.security.config.ISecurityUserService;
import com.matri.Matri.security.dto.PasswordDto;
import com.matri.Matri.security.dto.UserDto;
import com.matri.Matri.security.events.OnRegistrationCompleteEvent;
import com.matri.Matri.security.exception.InvalidOldPasswordException;
...
public class RegistrationController {
	...
	@RequestMapping("/user/registration/showSuccessPage")
	public String navigateToSuccesMailDelPageAfterReg() {
		return "redirect:/successRegister.html";
	}
	...
	public String confirmRegistration(final HttpServletRequest request, final Model model,
		...
		if (result.equals("valid")) {
			...
			return "redirect:/createremainingprofile.html?lang=" + locale.getLanguage();
		}
